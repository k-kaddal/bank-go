...
func TestTransferTxDeadlock(t *testing.T) {
	...
	for i :=0; i < n; i++{
		// reverse transactions by reversing the roles of accounts 
		fromAccountId := account1.ID
		toAccountId := account2.ID
		if i % 2 == 1 {
	...
	// updated balances should equal to the original balance state
	// as half of the transactions are reversed
